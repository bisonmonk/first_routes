...
ActiveRecord::Schema.define(version: 20140422231946) do
  ...
  add_index "group_contacts", ["group_id", "contact_id"], name: "index_group_contacts_on_group_id_and_contact_id", unique: true, using: :btree
